...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_61_split_rshift(
        ...
        _______,          KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, KC_VOLU, KC_END,  KC_MUTE, RGB_HUI, RGB_MOD, RGB_VAI, _______, _______,
