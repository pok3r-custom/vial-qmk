# Vortex Keyswitch Sampler Tester

A numpad with a selection of key switches and per-key RGB lighting. 

LEDs can be installed on the non-RGB variant.
Use a reverse-mounted RGB LED like XZMDKCBDDG45S-9.

* Keyboard Maintainer: [ChaoticEnigma](https://github.com/ChaoticEnigma)
* Hardware Supported: Vortex Keyswitch Sampler Tester
...
* Mini-USB port
* Micro-USB port wired with UART

## How to compile

Make example for this keyboard (after setting up your build environment):

    make vortex/sampler:default
...
Flashing example for **unlocked** keyboard:
    ...
    make vortex/sampler:default:flash
...
```bash
$ ht32-dfu-tool -w -r write -m 0 /path/to/vortex_sampler_default.bin
```
